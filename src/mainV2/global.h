...
#define LOG_OUTPUT_VISUALIZER_MODE 1     // 0 or 1, 1(default) => visualizer-mode, 0=human-readable-mode
...
#define TASK_EMERGENCY 6
#define TASK_RECEIVER 7           // remember, receiver is not a real cooptask
#define TASK_MIXER 8              // remember, mixer is not a real cooptask
...
// note : mocked values must start >= 1, because default value (no mocking) is 0 !!!!
#define MOCK_RECEIVER_READ 1     // for read(), if 1, arming=true, all gimbals in CP, T=1500, H=0   
